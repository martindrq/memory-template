                ...
                "todos_list": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "project_name": {
                                "type": "string",
                                "description": "Todo project. If not set, the todo is put in the user's Inbox.",
                            },
                            "importance": {
                                "type": "integer",
                                "description": "Can be from 1 to 5. 1 very important. 5 low importance.",
                            },
                            "urgence": {
                                "type": "integer",
                                "description": "Can be from 1 to 5. 1 very urgence. 5 low urgence.",
                            },
                            "labels": {
                                "type": "array",
                                "items": {"type": "string"},
                                "description": "The todo's labels to organize and classify todos.",
                            },
                            "due_date": {
                                "type": "string",
                                "format": "date",
                            ...
                            "status": {
                                "type": "string",
                                "description": "A status for the todo.",
                            },
                        }
                    },
                },
